...
public class CityController {
	...
	@RequestMapping(path = "/{id}/people", method = RequestMethod.GET)
	public List<AppPerson> indexPeople(@PathVariable("id") long id) {
		return cityService.indexPeople(id);
	}
	
	//GET     /api/cities/{id}/groups
	@RequestMapping(path = "/{id}/groups", method = RequestMethod.GET)
	public List<AppGroup> indexGroups(@PathVariable("id") long id) {
		return cityService.indexGroups(id);
	}
}
